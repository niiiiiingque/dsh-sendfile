...
export function apply(ctx) {
  ...
  const section = ctx.settings.register(namespace, z.object({ maxChars: z.number().min(1000).max(200000).default(200000), maxFileMB: z.number().min(1).max(64).default(32) }), { base: DEFAULTS, validate: clampSettings });
